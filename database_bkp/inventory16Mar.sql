...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$180000$EhZkQGrT5aBV$t+VX264xKK5M1qx3wNSbNOyZIhnwefGa1e4hc1AzGL8=','2020-03-16 10:01:05.854558',1,'admin','Naveen','Chauhan','naveen.chauhan010@gmail.com',1,1,'2020-01-30 13:05:47.000000'),(2,'pbkdf2_sha256$180000$UFU2e9LRLQ2Y$T2rlj/F9bT4gOdkcG/Flh41XjxWbUA/bSEUXpGhYbBo=','2020-03-16 11:04:51.929071',0,'allied_autotech','','','',1,1,'2020-03-16 09:23:45.000000');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(31,'areapincode','areapincode'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(19,'brand','brand'),(20,'brand','brandcategory'),(10,'Car','carmaker'),(17,'Car','carmodel'),(27,'category','category'),(9,'CategoryManagement','category'),(8,'CategoryManagement','subcategory'),(5,'contenttypes','contenttype'),(7,'inventory','techusers'),(23,'part','autopart'),(26,'part','autopartbrand'),(24,'part','autopartcategory'),(30,'part','autopartcompatibility'),(28,'part','autopartpicture'),(29,'part','autopartseller'),(22,'seller','seller'),(21,'seller','sellercategory'),(6,'sessions','session');
...
INSERT INTO `part_autopart` VALUES (3,'Part 1','123456','<p>Feature</p>','Part Desc','OM','2020-03-16 07:16:00.269354','2020-03-16 07:16:00.343254');
...
CREATE TABLE `part_autopartcompatibility` (
  ...
  KEY `part_autopartcompati_carmaker_id_2c6f1453_fk_car_carma` (`carmaker_id`),
  CONSTRAINT `part_autopartcompati_autopart_id_31394bed_fk_part_auto` FOREIGN KEY (`autopart_id`) REFERENCES `part_autopart` (`id`),
  CONSTRAINT `part_autopartcompati_carmaker_id_2c6f1453_fk_car_carma` FOREIGN KEY (`carmaker_id`) REFERENCES `car_carmaker` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `part_autopartcompatibility_carmodel`
--

DROP TABLE IF EXISTS `part_autopartcompatibility_carmodel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `part_autopartcompatibility_carmodel` (
  `id` int NOT NULL AUTO_INCREMENT,
  `autopartcompatibility_id` int NOT NULL,
  `carmodel_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `part_autopartcompatibili_autopartcompatibility_id_23210939_uniq` (`autopartcompatibility_id`,`carmodel_id`),
  KEY `part_autopartcompati_carmodel_id_ef160ce1_fk_car_carmo` (`carmodel_id`),
  CONSTRAINT `part_autopartcompati_autopartcompatibilit_2657be0d_fk_part_auto` FOREIGN KEY (`autopartcompatibility_id`) REFERENCES `part_autopartcompatibility` (`id`),
  CONSTRAINT `part_autopartcompati_carmodel_id_ef160ce1_fk_car_carmo` FOREIGN KEY (`carmodel_id`) REFERENCES `car_carmodel` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `part_autopartcompatibility_carmodel`
--

LOCK TABLES `part_autopartcompatibility_carmodel` WRITE;
/*!40000 ALTER TABLE `part_autopartcompatibility_carmodel` DISABLE KEYS */;
/*!40000 ALTER TABLE `part_autopartcompatibility_carmodel` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `part_autopartpicture` VALUES (1,'autopart/123456/screenshot-2020-01-27-at-125040-pmpng',3),(2,'autopart/123456/screenshot-2020-02-04-at-30133-pmpng',3),(3,'autopart/123456/thumbjpeg',3);
...
INSERT INTO `seller_seller` VALUES (2,'Selller 1','Nav','+18989898989','Test Seller','http://icrackexam.com','assets/seller/graduate-user-icon.png','2020-03-03 11:12:27.293222','2020-03-03 11:12:27.293270');
...
INSERT INTO `seller_sellercategory_category` VALUES (2,4,7),(1,4,8);
...
-- Dump completed on 2020-03-16 17:24:36
